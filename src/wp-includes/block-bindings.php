 ...
 */
function replace_block_attribute_value( WP_Block_Type $block_type, string $block_content, string $attribute_name, $source_value ) {
		...
		case 'rich-text':
			...
			foreach ( $selectors as $selector ) {
				...
				if ( strcasecmp( $block_reader->get_tag(), $selector ) === 0 || $block_reader->next_tag(
					...
					if ( 'core/paragraph' === $block_type->name || 'core/heading' === $block_type->name ) {
